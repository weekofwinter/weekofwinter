          ...
          <div className={s.innerContent}>
            ...
            <section id="arets-resa" className={s.section}>
              <Trip
                ...
                date={data.trip.date}
                ticket={`Bokningen öppnar ${data.trip.bookingOpens}`}
                place={data.trip.destination.name}
                placeLink={data.trip.destination.link}
                description={data.trip.description}
                imageSrc={data.trip.image.src}
                imageAlt={data.trip.image.alt}
              />
